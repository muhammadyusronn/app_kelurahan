...
<body class="bg-silver-300">
    <div class="content">
        <form id="login-form" class="mt-4" action="<?= base_url('register') ?>" method="post">
            ...
            <div class="form-group">
                <div class="input-group-icon right">
                    ...
                    <input class="form-control" type="text" name="nik" placeholder="Nomor Induk Kependudukan" autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group-icon right">
            ...
            <div class="form-group">
                <div class="input-group-icon right">
                    <div class="input-icon"><i class="fa fa-user"></i></div>
                    <input class="form-control" type="text" name="kontak" placeholder="Nomor Hanphone Aktif">
                </div>
            </div>
            <div class="form-group">
                Anda sudah memiliki akun? Silahkan login <a href="<?= base_url('login') ?>"><strong>disini</strong></a>
            </div>
            <div class="form-group">
                <a href="<?= base_url('/') ?>"><strong>KEMBALI KE HALAMAN UTAMA</strong></a>
            </div>
            <div class="form-group">
                <button class="btn btn-info btn-block" name="submit" type="submit">REGISTER</button>
            </div>
        </form>
    </div>
